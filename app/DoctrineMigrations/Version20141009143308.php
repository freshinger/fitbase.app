 ...
 */
class Version20141009143308 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE fitbase_weeklyquiz_answer CHANGE question_id question_id INT DEFAULT NULL, CHANGE quiz_id quiz_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE fitbase_weeklyquiz_answer CHANGE quiz_id quiz_id INT NOT NULL, CHANGE question_id question_id INT NOT NULL');

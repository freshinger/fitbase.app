...
CONTENT
    ...
    public function createGlobalPage(SiteInterface $site)
    {
        ...
        $text->setType('sonata.block.service.text');
        $text->setSetting('content', '<h2><a href="/">Fitbase</a></h2>');
        $text->setPosition(1);
        $text->setEnabled(true);
        $text->setPage($global);
        ...
        $text->setType('sonata.block.service.text');
        $text->setSetting('content', '<h2>Fitbase</h2><p class="handcraft">HANDCRAFTED IN PARIS<br />WITH MIXED HERITAGE</p><p><a href="http://twitter.com/sonataproject" target="_blank">Follow Sonata on Twitter</a></p>');
